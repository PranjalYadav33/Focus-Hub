...
const OfflineIndicator: React.FC = () => {
  ...
  if (!isOnline) {
    return (
      <div className="fixed top-16 left-4 right-4 z-50 rounded-md bg-destructive text-destructive-foreground px-4 py-2 border shadow-sm flex items-center justify-center">
  ...
  if (showOfflineMessage) {
    return (
      <div className="fixed top-16 left-4 right-4 z-50 rounded-md bg-secondary text-secondary-foreground px-4 py-2 border shadow-sm flex items-center justify-center animate-pulse">
